...
class NewProduct(Gtk.Window):
    ...
    def id_area(self):
        ...
        self.id_label.set_markup("<b>ID</b>")
    ...
    def type_area(self):
        ...
        self.type_label.set_markup("<b>Tipo</b>")
    ...
    def description_area(self):
        ...
        self.description_label.set_markup("<b>Descripcion</b>")
    ...
    def price_area(self):
        ...
        self.amount_label.set_markup("<b>Cantidad</b>")
        ...
        self.value_label.set_markup("<b>Precio</b>")
